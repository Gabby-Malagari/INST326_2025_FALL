...
#### **`3. algorithm 3.py`**
- Simulates how resources, such as food and water change over time.
...
- Contains run_island_survivor() which houses the main game logic and calls other functions in order to run
#### **`6.team_members.py`**
